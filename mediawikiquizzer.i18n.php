...
$messages['en'] = array(
    ...
    'mwquizzer-variant-already-seen'    => 'You have already tried this variant. Try another one.',
    ...
    'mwquizzer-parse-choice'        => 'Choice|Answer',
    'mwquizzer-parse-choices'       => 'Choices|Answers',
    'mwquizzer-parse-correct'       => '(?:Correct|Right)\s*(?:Choice|Answer)[:\s]*',
...
$messages['ru'] = array(
    ...
    'mwquizzer-variant-already-seen'    => 'На этот вариант вы уже отвечали. Попробуйте другой вариант.',
    ...
    'mwquizzer-parse-choice'        => 'Ответ|Choice|Answer',
    'mwquizzer-parse-choices'       => 'Ответы|Варианты\s*ответа|Choices|Answers',
    'mwquizzer-parse-correct'       => '(?:Правильный\s*ответ|(?:Correct|Right)\s*(?:Choice|Answer))[:\s]*',
