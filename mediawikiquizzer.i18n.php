...
Then click "Select results" again.',
    ...
    'mwquizzer-test-average'            => '<i>All users average correct answers to this test ≈ <b>$1 %</b></i>',
...
Далее снова нажмите «Выбрать результаты».',
    ...
    'mwquizzer-test-average'            => '<i>Общий средний балл по данному тесту ≈ <b>$1 %</b> правильных ответов.</i>',
