...
Then click "Select results" again.',
    ...
    'mwquizzer-prompt-needed'           => 'mandatory field',
    'mwquizzer-empty'                   => 'Please fill in all mandatory fields!',
    ...
    'mwquizzer-variant-already-seen'    => '<b style="color: red">You have already tried this variant.</b>',
    'mwquizzer-try-another'             => '<a href="$1">Try another one.</a>',
    ...
    'mwquizzer-parse-form-text'     => 'Text[:\s]*',
    'mwquizzer-parse-form-name'     => 'Name[:\s]*',
    'mwquizzer-parse-form-m-fields' => 'Mandatory\s*fields[:\s]*',
    'mwquizzer-parse-form-m-field'  => 'Mandatory\s*field[:\s]*',
    'mwquizzer-parse-form-fields'   => 'Fields[:\s]*',
    'mwquizzer-parse-form-field'    => 'Field[:\s]*',
    'mwquizzer-parse-form-m-checks' => 'Mandatory\s*checkboxes[,\s]*',
    'mwquizzer-parse-form-m-check'  => 'Mandatory\s*checkbox[,\s]*',
    'mwquizzer-parse-form-checks'   => 'Checkboxes[,\s]*',
    'mwquizzer-parse-form-check'    => 'Checkbox[,\s]*',
...
Далее снова нажмите «Выбрать результаты».',
    ...
    'mwquizzer-prompt-needed'           => 'обязательное поле',
    'mwquizzer-empty'                   => 'Заполните все обязательные поля!',
    ...
    'mwquizzer-variant-already-seen'    => '<b style="color: red">На этот вариант вы уже отвечали.</b>',
    'mwquizzer-try-another'             => '<a href="$1">Попробуйте другой вариант.</a>',
    ...
    'mwquizzer-parse-form-text'     => '(?:Текст|Text)[:\s]*',
    'mwquizzer-parse-form-name'     => '(?:Имя|Name)[:\s]*',
    'mwquizzer-parse-form-m-fields' => '(?:Обязательные\s*поля|Mandatory\s*fields)[:\s]*',
    'mwquizzer-parse-form-m-field'  => '(?:Обязательное\s*поле|Mandatory\s*field)[:\s]*',
    'mwquizzer-parse-form-fields'   => '(?:Поля|Fields)[:\s]*',
    'mwquizzer-parse-form-field'    => '(?:Поле|Field)[:\s]*',
    'mwquizzer-parse-form-m-checks' => '(?:Обязательные\s*флажки|Mandatory\s*checkboxes)[,\s]*',
    'mwquizzer-parse-form-m-check'  => '(?:Обязательный\s*флажок|Mandatory\s*checkbox)[,\s]*',
    'mwquizzer-parse-form-checks'   => '(?:Флажки|Checkboxes)[,\s]*',
    'mwquizzer-parse-form-check'    => '(?:Флажок|Checkbox)[,\s]*',
