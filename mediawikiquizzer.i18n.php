...
Then click "Select results" again.',
    ...
    'mwquizzer-variant-already-seen'    => 'You have already tried this variant.',
    'mwquizzer-try-another'             => 'Try <a href="$1">another one</a>.',
...
Далее снова нажмите «Выбрать результаты».',
    ...
    'mwquizzer-variant-already-seen'    => 'На этот вариант вы уже отвечали.',
    'mwquizzer-try-another'             => 'Попробуйте <a href="$1">другой вариант</a>.',
